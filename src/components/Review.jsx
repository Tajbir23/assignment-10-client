  ...
  return (
	...
	<div className="flex flex-col items-center w-full">
		...
		<div className="flex flex-col w-full">
			<textarea rows="3" placeholder="Message..." className="p-4 rounded-md resize-none dark:bg-black text-white "></textarea>
			<button type="button" className="py-4 my-8 font-semibold rounded-md text-black bg-violet-600">Leave feedback</button>
		</div>
	</div>
	<div className="flex items-center justify-center">
		<a rel="noopener noreferrer" href="#" className="text-sm ">Maybe later</a>
	</div>
</div>
  )
}
