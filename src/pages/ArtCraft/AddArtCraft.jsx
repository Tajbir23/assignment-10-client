      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" id="image" name="image" className="w-full border rounded py-2 px-3" required />
          </div>
          <div>
            <label htmlFor="item_name" className="block mb-2">Item Name</label>
            <input type="text" id="item_name" name="item_name" className="w-full border rounded py-2 px-3" required />
          </div>
        </div>
        <div className="mb-4">
          <label htmlFor="subcategory_name" className="block mb-2">Subcategory Name</label>
          
          <select id="subcategory_name" name="subcategory_name" className="w-full border rounded py-2 px-3" required>
        ...
        <div className="mb-4">
          ...
          <textarea id="short_description" name="short_description" className="w-full border rounded py-2 px-3" required />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="price" className="block mb-2">Price</label>
            <input type="number" id="price" name="price" className="w-full border rounded py-2 px-3" required />
          </div>
          <div>
            <label htmlFor="rating" className="block mb-2">Rating</label>
            <input type="number" id="rating" name="rating" className="w-full border rounded py-2 px-3" required />
          </div>
        </div>
        <div className="mb-4">
          <label htmlFor="customization" className="block mb-2">Customization</label>
          <select id="customization" name="customization" className="w-full border rounded py-2 px-3" required>
        ...
        <div className="mb-4">
          ...
          <input type="text" id="processing_time" name="processing_time" className="w-full border rounded py-2 px-3" required />
        </div>
        <div className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="email" id="user_email" name="user_email" disabled defaultValue={user?.email} className="w-full border rounded py-2 px-3" required />
          </div>
          <div>
            <label htmlFor="user_name" className="block mb-2">User Name</label>
            <input type="text" id="user_name" name="user_name" disabled defaultValue={user?.displayName} className="w-full border rounded py-2 px-3" required />
          </div>
        </div>
